<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="statusfromowaitoknoonlyyesorno.aspx.cs" Inherits="personnelformwaitdelete" EnableEventValidation="false" %>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-sm-3 form-control-label">審核備註:</label>
                                <div class="col-sm-9">

                                    <%--<textarea id="TextArea1"  cols="70" rows="6" CssClass= "form-control input-material" runat="server" required="" placeholder="敘述流程" ></textarea>--%>
                                    <%--<asp:TextBox ID="TextBox7" runat="server" cols="70" rows="6" CssClass="form-control" disabled="" ></asp:TextBox>--%>
                                    <textarea id="TextArea2" style="width:100%" rows="6" cssclass="form-control " runat="server"  placeholder="審核備註"></textarea>
                                </div>
                            </div>
                            <div class="line"></div>
                            <div class="form-group row">
                                <div class="col-sm-4 offset-sm-3">
                                    ...
                                    <asp:Button ID="Button2" runat="server" CssClass="btn btn-primary" OnClientClick="return false"  OnClick="Button2_Click" formnovalidate Text="審核通過不通過" />
                                    <input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />

                                    
                                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click"  CssClass="btn btn-primary" formnovalidate  OnClientClick="return false" Text="審核通過" />
                                    <asp:Button ID="Button3" runat="server"  OnClick="Button3_Click" CssClass="btn btn btn-secondary" formnovalidate Text="離開頁面"/>
