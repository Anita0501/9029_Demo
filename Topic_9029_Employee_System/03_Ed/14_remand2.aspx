<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="14_remand2.aspx.cs" Inherits="Demo" EnableEventValidation="false" %>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="idUserName" type="text" placeholder="名稱" runat="server" class="form-control form-control-success"><small class="form-text"></small>
                                </div>
                            </div>
                            <%--欄位--%>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-9 offset-sm-3">
                                    <asp:Button ID="Button1" runat="server" Text="確認" Class="btn btn-primary" />
                                </div>
                            </div>
                        </form>
                    </div>
